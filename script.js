...
window.mobileAndTabletCheck = function() {
  ...
  if (check == true){
    document.getElementById("assign_button").setAttribute("onclick","assign()");
    document.getElementById("assign_button").onmousedown = function() {};
    document.getElementById("assign_button").onmouseup = function() {};
